...
<html lang="en">
    <head>
        ...
        <title>Intranet-Eventos Próximos</title>
            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid px-4">
                        <h1 class="mt-4">Eventos Próximos</h1>
                        <ol class="breadcrumb mb-4">
                            <li class="breadcrumb-item"><a href="verInicio">Inicio</a></li>
                            <li class="breadcrumb-item active">Eventos Próximos</li>
                        </ol>
                        <div class="card mb-4">
                            <div class="card-body t2">
                                <i class="bi bi-file-earmark"></i>
                                <a href="verIntraEventosProximosCrear" class="t2">Crear Evento</a>
                            </div>
                        </div>
                        <div class="card mb-4">
                                ...
                                <div class="row">
                                   ...
                                   <div class="col-lg-4 col-md-6 portfolio-item">
                                    ...
                                    <div class="col-lg-8 col-md-6 portfolio-item">
                                      <div class="card-body">
                                       <input class="form-control" id="id" name="idEventosProximos" maxlength="8" type="hidden"/>	
                                            <div class="form-group mt-3">
                                              ...
                                              <div class="row">
                                                <div class="col-md-6">
                                                    ...
                                                    <input  type="date" name="fecha" id="id_fecha" class="form-control day2">
                                                  </div>
                                                  <div class="col-md-6">
                                                    <label for="inputState" class="form-label">Hora</label>
                                                    <input type="time" name="hora" id="id_hora" class="form-control day3">
                                                  </div>
      ...
      <div class="modal-footer">
		...
		<script type="text/javascript">
		 ...
		 window.onload=function listar(){
	        	$.getJSON("listaEventosProximos", function (listado){
		 ...
		 $("#id_btn_filtrar").click(function(){
	        	...
	        	$.getJSON("listaEventosProximosxTitulo",{"filtro":fil}, function (lista){
	        		agregarGrilla(lista);
	        	});
	        });
	    	 ...
	    	 /* METODO PARA ACTUALZAR*/    
	    	  ...
	    	  if (validator.isValid()) {
	    		  ...
	    		  formData.append("idEventosProximos", $("#id").val());
	    		  ...
	    		  formData.append("hora", $("#id_hora").val());
	    		  formData.append("estado", $("#id_estado").val());
	    		  
	    		  
	    		  
	    	      $.ajax({
	    	        type: "POST",
	    	        url: "actualizaEventosProximos", 
	    	        data: formData,
	    		...
	    		return false;	
	    	    	...
	    	    	function editar(id,titulo,descripcion,fecha,hora,estado,foto){	
		...
		function agregarGrilla(lista){
	       	 ...
	       	 $('#id_table').DataTable({
	       			...
	       			columns:[
	       				...
	       				{data: function(row, type, val, meta){
	       					var salida='<button class="table-btn-crud" id="botoneditar" data-bs-toggle="modal" data-bs-target="#id_modal_actualiza" onclick="editar(\''+row.idEventosProximos + '\',\'' + row.titulo + '\',\'' + row.descripcion+ '\',\'' +row.fecha+ '\',\'' +row.hora+ '\',\'' +row.estado+'\',\'' +row.foto+'\')" ><i class="bi bi-pencil"></i></button>';
