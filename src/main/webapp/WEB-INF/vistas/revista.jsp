...
<script type="text/javascript" src="https://code.jquery.com/jquery-3.5.1.js"></script>
  ...
  <link href="css/revista.css" rel="stylesheet">
          ...
          <div class="col-lg-10">
            <div class="card mb-3">
              <div class="row g-0">
                ...
                <div class="col-md-8">
                  <div class="card-body">
                    <h5 class="card-title"><a href="revista-sub.html" class="card-link tet">Derecho Internacional Económico: Temas actuales en comercio, inversión y derecho transnacional</a></h5>
