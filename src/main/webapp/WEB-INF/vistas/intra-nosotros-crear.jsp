                            ...
                            <div class="container-fluid px-4 d2">
                                <div class="row">
                                    ...
                                    <div class="col-lg-4 col-md-6 portfolio-item">
                                          <img src="img/img_nosotros.jpg" id="foto_nosotros" class="card-img-top" alt="...">
                                        <label 
                                    ...
                                    <div class="col-lg-8 col-md-6 portfolio-item">
                                            ...
                                            <div class="form-group mt-3">
                                              ...
                                              <div class="b3">
                                                <a href="verNosotros"><button type="button" id="id_cancelar" class="btn btn-secondary">Cancelar</button></a>
