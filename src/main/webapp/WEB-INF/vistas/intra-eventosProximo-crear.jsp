                ...
                <main>
                    <div class="container-fluid px-4">
                        ...
                        <ol class="breadcrumb mb-4">
                            ...
                            <li class="breadcrumb-item"><a href=verIntraEventosProximos>Eventos Próximos</a></li>
                                    ...
                                    <div class="col-lg-8 col-md-6 portfolio-item">
                                      <div class="card-body">
                                            ...
                                            <div class="form-group mt-3">
                                              ...
                                              <div class="b3">
                                                <a href="verIntraEventosProximos"><button type="button" class="btn btn-secondary" id="btn_cancelar">Cancelar</button></a>
    	  ...
    	  fields: {
    	      ...
    	      fecha: {
				...
				hora: {
						...
						validators: {
							notEmpty: {
								message: '*Seleccione la hora de publicación'
							},
						}
					},
