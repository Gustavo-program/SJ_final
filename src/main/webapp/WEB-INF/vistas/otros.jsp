  ...
  <main id="main">
    ...
    <section id="about" class="about">
      <div class="container">
        ...
        <div class="row row-cols-1 row-cols-md-3 g-4" id="listaOtros">
        ...
        <!-- 
          <div class="col">
            <div class="card">
              ...
              <div class="card-body">
                <h5 class="card-title"><a href="Otros-sub.html" class="card-link ter">CURSO INTERDISCIPLINARIO DE DERECHO</a></h5>
...
$.getJSON("listaEventosOtros", function (data){				
