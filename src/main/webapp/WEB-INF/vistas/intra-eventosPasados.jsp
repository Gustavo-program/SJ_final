                            ...
                            <div class="container-fluid px-4 d2">
                                <div class="row">
                                    ...
                                    <div class="col-lg-8 col-md-6 portfolio-item">
                                      <div class="card-body">
                                      <input class="form-control" id="id" name="idEventosPasados" maxlength="8" type="hidden"/>	
        	...
        	$.getJSON("listaEventosPasadosxTitulo",{"filtro":fil}, function (lista){
	    	 ...
	    	 /* METODO PARA ACTUALZAR*/    
	    	  ...
	    	  if (validator.isValid()) {
	    		  ...
	    		  formData.append("idEventosPasados", $("#id").val());
