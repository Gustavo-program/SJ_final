                                  ...
                                  <div class="row" >
                                	...
                                	Publicar 
                               		...
                               		<div class="col-md-6 input-group w-50">
	                               		 	<input id="id_txt_filtro" name="filtro" class="form-control" placeholder="Ingrese el título de la Revista"  />
                            ...
                            <div class="container-fluid px-4 d2">
                                <div class="row">
                                     ...
                                     <div class="col-lg-4 col-md-6 portfolio-item">
                                          <img src="img/img_noticias.jpg" id="foto_revista" class="card-img-top" alt="...">
                                        <label 
                                    ...
                                    <div class="col-lg-8 col-md-6 portfolio-item">
                                      ...
                                      <input class="form-control" id="id" name="idrevistas" maxlength="8" type="hidden"/>
                                        <div class="form-group mt-3">
                                              ...
                                              <div class="form-group mt-3">
                                                <input type="text" class="form-control" name="anno" id="id_anno" placeholder="N° (Año)" required>
                                              </div>
                                              <div class="form-group mt-3">
                                                <textarea class="form-control" name="descripcion" id="id_descripcion" rows="3" placeholder="Descripción" required></textarea>
                                              </div>
                                              <br>
                                              <div class="row">
                                                <div class="form-group mb-3">
                                                    <label for="formFile" class="form-label">PDF Completo <i class="bi bi-file-pdf"></i></label>
                                                    <textarea class="form-control" name="pdf" id="id_pdf" placeholder="Link del la Revista" required></textarea>
                                                  </div>
                                                  
                                                <div class="col-md-12">
                                                    <label for="id_rama" class="form-label">Rama</label>
      ...
      <div class="modal-footer">
		...
		<script>
		 ...
		 window.onload=function listar(){
	        	$.getJSON("listaRevista", function (listado){
	 	  ...
	 	  if (validator.isValid()) {
	 		  ...
	 		  formData.append("anno", $("#id_anno").val());
			 ...
			 <!-- EDITAR DATOS DE NOTICIAS -->
	 	    	function editar(id,titulo,anno,descripcion,pdf,rama,foto){	
	 	    		...
	 	    		document.getElementById('foto_revista').setAttribute('src',foto);
	       	 ...
	       	 $('#id_table').DataTable({
	       			...
	       			columns:[
	    				...
	    				{data: function(row, type, val, meta){
	       				...
	       				{data: function(row, type, val, meta){
	       					var salida='<button class="table-btn-crud" id="botoneditar"  onclick="eliminar(\''+row.idrevistas+'\')" ><i class="bi bi-trash"></i></button>';
