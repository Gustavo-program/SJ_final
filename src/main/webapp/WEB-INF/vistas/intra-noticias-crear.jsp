...
<html lang="en">
    ...
    <body class="sb-nav-fixed">
       ...
       <jsp:include page="nav-responsive.jsp"></jsp:include>
                ...
                <main>
                    <div class="container-fluid px-4">
                        ...
                        <ol class="breadcrumb mb-4">
                            ...
                            <li class="breadcrumb-item"><a href="verIntraNoticias">Noticias</a></li>
                            ...
                            <div class="container-fluid px-4 d2">
                                <div class="row">
                                    <div class="col-lg-4 col-md-6 portfolio-item">
                                        ...
                                        <div class="card mb-4">
                                            <div class="card-body">Tamaño establecido es 1920 - 1280 (Pixeles)
                                            </div>
                                        </div>
                                        <div class="mb-3">
        ...
        <script src="assets/js/inicio sesiÃ³n/scripts.js"></script>
        <script src="https://cdnjs.cloudflare.com/ajax/libs/Chart.js/2.8.0/Chart.min.js" crossorigin="anonymous"></script>
        <script src="assets/demo/chart-area-demo.js"></script>
        <script src="assets/demo/chart-bar-demo.js"></script>
        <script src="https://cdn.jsdelivr.net/npm/simple-datatables@latest" crossorigin="anonymous"></script>
        <script src="assets/js/inicio sesiÃ³n/datatables-simple-demo.js"></script>
    </body>
</html>
