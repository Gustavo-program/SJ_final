                ...
                <main>
                    <div class="container-fluid px-4">
                        ...
                        <ol class="breadcrumb mb-4">
                            ...
                            <li class="breadcrumb-item"><a href="verSlider">Slider</a></li>
                            ...
                            <div class="container-fluid px-4 d2">
                                <div class="row">
                                    <div class="col-lg-4 col-md-6 portfolio-item">
                                        ...
                                        <div class="card mb-4">
                                            <div class="card-body">Tamaño establecido es 1920 - 910 (Pixeles)
                                            </div>
                                        </div>
                                        <div class="mb-3">
                                        ...
                                        <form>
                                            <div class="form-group mt-3">
                                              ...
                                              <div class="form-group mt-3">
                                                ...
                                                <div id="emailHelp" class="form-text">Recuerde que la descripción debe de ser breve como máx. 20</div>
                                              </div>
                                              <br>
