                    ...
                    <div class="container-fluid px-4">
                        ...
                        <div class="card mb-4">
                            <div class="card-body t2">
                                ...
                                <a href="verIntraNoticiasCrear" class="t2">Crear Noticias</a>
                            </div>
                        </div>
                        <div class="card mb-4">
		...
		function agregarGrilla(lista){
	       	 ...
	       	 $('#id_table').DataTable({
	       			...
	       			columns:[
	       				...
	       				{data: function(row, type, val, meta){
	       					var salida='<button class="table-btn-crud" id="botoneditar" data-bs-toggle="modal" data-bs-target="#id_modal_actualiza" onclick="editar(\''+row.idNoticias + '\',\'' + row.titulo + '\',\'' + row.descripcion.replace(/\n/g, "\\r") + '\',\'' +row.tipo.idTipoNoticias+ '\',\'' +row.rama.idRama+'\',\'' +row.imagen+'\')" ><i class="bi bi-pencil"></i></button>';
