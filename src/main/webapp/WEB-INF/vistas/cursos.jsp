  ...
  <main id="main">
    ...
    <section id="about" class="about">
      <div class="container">
        ...
        <div class="row row-cols-1 row-cols-md-3 g-4" id="listaCurso">
...
$.getJSON("listaEventosCursos", function (data){				
		...
		$('#listaCurso').append(
				 ...
				 "<div class='col'>"+
		            "<div class='card cardStyle'>"+
		              ...
		              "<div class='card-body'>"+
		                "<h5 class='card-title'>"+
		                "<a href='detalleCursos?id="+item.idEventosSco+"' class='card-link ter'>"+
		                 item.titulo+
		                "</a>"+
		                "</h5>"+
