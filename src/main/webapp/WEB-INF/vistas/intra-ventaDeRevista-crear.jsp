                            ...
                            <div class="container-fluid px-4 d2">
                                <div class="row">
                                    <div class="col-lg-4 col-md-6 portfolio-item">
                                        ...
                                        <div class="card mb-4">
                                            <div class="card-body">Tama�o establecido es 784 - 1164 (Pixeles)
                                            </div>
                                        </div>
                                        <div class="mb-3">
                                      ...
                                      <div class="card-body">
                                        <form>
                                            <div class="form-group mt-3">
                                              ...
                                              <div class="form-group mt-3">
                                                <input type="text" class="form-control" name="subject" id="subject" placeholder="Núm. 00 (año)" required>
                                              </div>
                                              <div class="form-group mt-3">
                                                <textarea class="form-control" name="message" rows="3" placeholder="Descripción" required></textarea>
                                              </div>
                                              <br>
                                              <div class="row">
                                                <div class="mb-3">
                                                ...
                                                <div class="col-md-6">
                                                    ...
                                                    <select id="inputState" class="form-select">
                                                      ...
                                                      <option>Derecho Registral</option>
                                                    </select>
                                                  </div>
                                              </div>
                                              <div class="b3">
